...
const DeviceGroupPage: React.FC = () => {
  ...
  return (
    <div>
      <PageHeader title="设备分组" extra={<Space><Button icon={<ReloadOutlined />} onClick={() => void fetchTree()} /><Button type="primary" icon={<PlusOutlined />} onClick={() => { setEditingRecord(null); setEditorOpen(true); }}>新建分组</Button></Space>} />
