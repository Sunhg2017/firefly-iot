...
class TcpUdpProtocolAdapterTest {
    ...
    @BeforeEach
    void setUp() {
        tcpUdpProtocolAdapter = new TcpUdpProtocolAdapter(new ObjectMapper(), deviceMessageProducer, protocolParseEngine);
    }
    ...
    void handleTcpMessageShouldUseBindingContextForParseAndFallback() {
        ...
        tcpUdpProtocolAdapter.handleTcpMessage("tcp-1", sessionInfo, "{\"temp\":25}");
    ...
    void handleUdpMessageShouldUsePeerBindingContext() {
        ...
        tcpUdpProtocolAdapter.handleUdpMessage("127.0.0.1:8901", peerInfo, "raw-message");
